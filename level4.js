var level4={
  ...
  create:function(){
      ...
      this.background = this.game.add.sprite(0,0,"background4");
    ...
    var enemyData = [
        {
            key:"turtle",x:150,y:100
          },
          {
            key:"fish",x:250,y:100
          },
          {
            key:"octopus",x:400,y:100
          },
          {
            key:"crab",x:550,y:100
          },
          {
            key:"bat",x:700,y:100
          }
      ...
      var playerData = [
          {
            key:"crab",x:100,y:500
          },
          {
            key:"octopus",x:250,y:500
          },
          {
            key:"turtle",x:400,y:500
          },
          {
            key:"bat",x:550,y:500
          },
          {
            key:"fish",x:700,y:500
          }
        ...
        //create text
        var style = {font:"bold 30px Arial",fill:"#b1eee6",align:"center"};
