var gameState={
  ...
  create:function(){
      ...
      this.snake.customParams="correct";
      ...
      this.player.events.onInputDown.add(this.dragPlayer,this);
  ...
  update:function(){
      this.game.physics.arcade.collide(this.player,this.imageGroup,this.checkCorrect,null,this);
